...
void MCMC_wrapper(int *dnumnets, int *dnedges,
		  ...
		  double *inputs, double *theta0, double *taperbeta, int *samplesize, 
...
MCMCStatus MetropolisHastings(MHproposal *MHp,
			      double *theta, double *taperbeta, double *statistics, 
...
void MCMCSamplePhase12 (MHproposal *MH,
  double *theta, double *taperbeta, double gain, double *meanstats,
