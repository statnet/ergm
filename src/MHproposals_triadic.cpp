...
extern "C" MH_P_FN(Mp_SPDyad){
  ...
  ErgmCppProposal<StoreDyadGenAndDegreeBound> p(MHp);
  ...
  if(unif_rand() > MH_INPUTS[0]){
    ...
    /*     switch(MH_IINPUTS[0]){ */
    /*     case L2UTP: */
    /*       SP01 = (OUT_DEG[*Mtail]+IN_DEG[*Mtail]) || (OUT_DEG[p.head[0]]+IN_DEG[p.head[0]]); break; */
    /*     case L2OTP: */
    /*     case L2ITP: */
    ...
    /*     switch(MH_IINPUTS[0]){ */
    /*     case L2UTP: */
    /*       SP10 = (OUT_DEG[*Mtail]+IN_DEG[*Mtail] == 1) || (OUT_DEG[p.head[0]]+IN_DEG[p.head[0]] == 1); break; */
    /*     case L2OTP: */
    /*     case L2ITP: */
