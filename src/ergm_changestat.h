...
#define _IS_OUTEDGE2(a,b) (EdgetreeSearch((a),(b),nwp->outedges)!=0?1:0)
...
#define _IS_INEDGE2(a,b) (EdgetreeSearch((a),(b),nwp->inedges)!=0?1:0)
...
#define _IS_UNDIRECTED_EDGE2(a,b) (EdgetreeSearch(MIN((a),(b)),MAX((a),(b)),nwp->outedges)!=0?1:0)
