...
Here, we will use some of the network objects included with the `statnet.data` package.  

```{r, eval=FALSE}
data(package='statnet.data') # tells us the datasets in our packages
```
...
```{r}
data(flomarriage, package="statnet.data") # loads flomarriage and flobusiness data
...
```{r }
data('faux.magnolia.high', package="statnet.data")
