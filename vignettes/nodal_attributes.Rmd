...
exclude. Thus, if `X` is not 0 or `NULL`, `base = X` can be replaced
with `levels = -X`. If `X` is 0 or `NULL`, `base = X` means to include
all levels, so it should be replaced with `levels = TRUE`.
