...
This document is an automatically generated cross reference for the ergm model terms from the [stanet project](http://statnet.org).  The source for this data and additional descriptions are in the `?ergm.terms` help file or the [ergm manual](https://cran.r-project.org/package=ergm). 
