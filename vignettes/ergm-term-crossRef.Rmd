...
ergm:::.termMatrix('ergmTerm',keywords=c('binary', 'valued', 'directed', 'undirected', 'bipartite', 'dyad-independent','operator','layer-aware'),only.include='frequently-used')
```

For convenience, this table lists operator terms: terms that wrap or modify other terms.

```{r,results='asis',echo=FALSE}
ergm:::.termMatrix('ergmTerm',keywords=c('binary', 'valued', 'directed', 'undirected', 'bipartite', 'dyad-independent','operator','layer-aware'),only.include='operator')
```
