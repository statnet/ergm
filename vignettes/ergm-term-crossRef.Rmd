...
```{r}
search.ergmTerms(search.term='triangle')
```
...
ergm:::.formatMatrixHtml(ergm:::.termMatrix('ergmTerm',keywords=c('binary', 'valued', 'directed', 'undirected', 'bipartite', 'dyad-independent', 'operator'), only.include='frequently-used'), wrapRdTags=FALSE)
```

For convenience, this table lists operator terms: terms that wrap or modify other terms.

```{r,results='asis',echo=FALSE}
ergm:::.formatMatrixHtml(ergm:::.termMatrix('ergmTerm',keywords=c('binary', 'valued', 'directed', 'undirected', 'bipartite', 'dyad-independent', 'operator'), only.include='operator'), wrapRdTags=FALSE)
```
