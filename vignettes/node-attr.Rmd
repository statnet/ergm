...
This document provides some examples of how to specify nodal attributes and their transformations in `ergm` terms. For the R help on the topic, see `help("node-attr")`.
