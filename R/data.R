...
#' 
#' This is a data set of business ties among Renaissance Florentine families.
#' The data is originally from Padgett (1994) via \code{UCINET} and stored as a
...
#' documents. The relations are business ties (\code{\link{flobusiness}} -
...
#' measure of power - for instance, a measure of wealth. Vertex information is
#' provided (1) \code{wealth} each family's net wealth in 1427 (in thousands of
#' lira); (2) \code{priorates} the number of priorates (seats on the civic
#' council) held between 1282- 1344; and (3) \code{totalties} the total number
...
#' @docType data
#' @name flobusiness
#' @seealso flo, network, plot.network, ergm, flomarriage
...
#' 
#' This is a data set of marriage ties among Renaissance Florentine families.
#' The data is originally from Padgett (1994) via \code{UCINET} and stored as a
#' \code{\link[network]{network}} object.
#' 
#' Breiger \& Pattison (1986), in their discussion of local role analysis, use
#' a subset of data on the social relations among Renaissance Florentine
#' families (person aggregates) collected by John Padgett from historical
#' documents. The relations are marriage alliances (\code{\link{flomarriage}}
#' betwween the families.
#' 
#' As Breiger \& Pattison point out, the original data are symmetrically coded.
#' This is perhaps acceptable perhaps for marital ties. Vertex information is
#' provided on (1) \code{wealth} each family's net wealth in 1427 (in thousands
#' of lira); (2) \code{priorates} the number of priorates (seats on the civic
#' council) held between 1282- 1344; and (3) \code{totalties} the total number
#' of business or marriage ties in the total dataset of 116 families (see
#' Breiger \& Pattison (1986), p 239).
#' 
