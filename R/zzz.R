...
.RegisterMHPs <- function(){
  ergm.MHP.table("c", "Bernoulli", c("", "bd"),  0, "random", "randomtoggle")
  ergm.MHP.table("c", "Bernoulli", c("", "bd"),  1, "TNT", "TNT")
  ergm.MHP.table("c", "Bernoulli", c(".dyads",".dyads+bd"),  -2, "random", "RLE")
  ergm.MHP.table("c", "Bernoulli", c(".dyads",".dyads+bd"),  -1, "TNT", "RLETNT")
  ...
  ergm.MHP.table("c", "Bernoulli", c("idegrees+odegrees","b1degrees+b2degrees"),  0, "random", "CondDegree")
  ...
  ergm.MHP.table("c", "Bernoulli", c("bd+edges","edges"),  0, "random", "ConstantEdges")
  ...
  ergm.MHP.table("c", "Bernoulli", c("bd+observed","observed"),  0, "random", "randomtoggleNonObserved")
  ergm.MHP.table("c", "Bernoulli", c("bd+observed","observed"),  1, "TNT", "NonObservedTNT")
  ergm.MHP.table("c", "Bernoulli", c("blockdiag","bd+blockdiag"), 0, "random", "blockdiag")
  ergm.MHP.table("c", "Bernoulli", c("blockdiag","bd+blockdiag"), 1, "TNT", "blockdiagTNT")
  ergm.MHP.table("c", "Bernoulli", c("blockdiag+observed","bd+blockdiag+observed"),  0, "random", "blockdiagNonObserved")
  ergm.MHP.table("c", "Bernoulli", c("blockdiag+observed","bd+blockdiag+observed"),  1, "TNT", "blockdiagNonObservedTNT")
