...
.RegisterKeywords <- function() {
  ergm_keyword(name="binary", short="bin", description="", popular=TRUE, package="ergm")
  ergm_keyword(name="bipartite", short="bip", description="", popular=TRUE, package="ergm")
  ...
  ergm_keyword(name="directed", short="dir", description="", popular=TRUE, package="ergm")
  ergm_keyword(name="discrete", short="discrete", description="", popular=FALSE, package="ergm")
  ergm_keyword(name="dyad-independent", short="dyad-indep", description="", popular=TRUE, package="ergm")
  ...
  ergm_keyword(name="nonnegative", short="nneg", description="", popular=FALSE, package="ergm")
  ergm_keyword(name="operator", short="op", description="", popular=TRUE, package="ergm")
  ergm_keyword(name="positive", short="pos", description="", popular=FALSE, package="ergm")
  ergm_keyword(name="quantitative nodal attribute", short="quant nodal attr", description="", popular=FALSE, package="ergm")
