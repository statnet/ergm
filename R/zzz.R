...
.RegisterProposals <- function(){
  ...
  ergm_proposal_table("c", "Bernoulli", "&TNT",  -10, "BDTNT", "BDTNT")
  ergm_proposal_table("c", "Bernoulli", "|bd&TNT",  -10, "StratTNT", "StratTNT")
  ergm_proposal_table("c", "Bernoulli", "&TNT",  -10, "BDStratTNT", "BDStratTNT")
