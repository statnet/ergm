...
.RegisterProposals <- function(){
  ...
  ergm_proposal_table("c", "Bernoulli", "|.dyads|bd|bdmax&sparse",  -1, "TNT", "TNT")
  ergm_proposal_table("c", "Bernoulli", "|bdmax|blocks&sparse",  -2, "BDTNT", "BDTNT")
  ergm_proposal_table("c", "Bernoulli", "|bd|bdmax|Strat&sparse",  -2, "StratTNT", "StratTNT")
  ergm_proposal_table("c", "Bernoulli", "|bdmax|blocks|Strat&sparse",  -3, "BDStratTNT", "BDStratTNT")
  ergm_proposal_table("c", "Bernoulli", c("&bdmax|blocks&sparse", "|bdmax&blocks&sparse"),  0, "BDTNT", "BDTNT")
  ergm_proposal_table("c", "Bernoulli", c("&bdmax|blocks|Strat&sparse", "|bdmax&blocks|Strat&sparse"),  0, "BDStratTNT", "BDStratTNT")
