#' Getting Started with "ergm": Fit, simulate and diagnose exponential-family
#' models for networks
#' 
#' \code{\link{ergm}} is a collection of functions to plot, fit, diagnose, and
#' simulate from random graph models. For a list of functions type:
#' help(package='ergm')
#' 
...
#' to be cited as given in \code{citation("ergm")}:
#' 
#' Mark S. Handcock, David R. Hunter, Carter T. Butts, Steven M. Goodreau, and
#' Martina Morris. 2003 \emph{ergm: Fit, simulate and diagnose
#' exponential-family models for networks} \cr \url{https://statnet.org}.
#' 
#' All published work derived from this package must cite it. For complete
#' citation information, use\cr \code{citation(package="ergm")}.
#' 
...
#' package which allows networks to be represented in . The \code{\link{ergm}}
#' package allows maximum likelihood estimates of exponential random network
#' models to be calculated using Markov Chain Monte Carlo.  The package also
#' provides tools for plotting networks, simulating networks and assessing
#' model goodness-of-fit.
#' 
#' For detailed information on how to download and install the software, go to
#' the \code{\link{ergm}} website: \url{https://statnet.org}. A tutorial,
#' support newsgroup, references and links to further resources are provided
#' there.
#' 
...
#' 
#' %Butts CT (2006). % \pkg{netperm}: Permutation Models for Relational Data. %
#' Version 0.2, \url{https://erzuli.ss.uci.edu/R.stuff}.
#' 
...
#' 
#' Butts C (2015).  \pkg{network}: The Statnet Project (https://statnet.org). R
#' package version 1.12.0, \url{https://cran.r-project.org/package=network}.
#' 
...
#' Models for Networks.  Statnet Project, Seattle, WA.  Version 2,
#' \url{https://statnet.org}.
#' 
...
#' Statnet Project, Seattle, WA.  Version 2, \url{https://statnet.org}.
#' 
