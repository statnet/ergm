#  File R/control.ergm.R in package ergm, part of the Statnet suite of packages
...
control.ergm<-function(drop=TRUE,
                       ...
                       MCMLE.min.depfac = MCMLE.samplesize.min / MCMLE.effectiveSize,
                       ...
                       CD.steplength.parallel = c("observational", "never"),
