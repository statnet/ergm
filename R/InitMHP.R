...
InitMHP.TriNT2 <- function(arguments, nw) {
  MHproposal <- list(name = "TriNT2", inputs=NULL)
  MHproposal
}

InitMHP.TribalancedNT <- function(arguments, nw) {
  MHproposal <- list(name = "TribalancedNT", inputs=NULL)
  MHproposal
}
