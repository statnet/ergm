...
test_that("b1twostar, bipartite, undirected", {
  ...
  s.aab <- summary(bipnw2~b1twostar(~Letter, "Color", levels=-(2:4)))
  e.aab <- ergm(bipnw2~b1twostar("Letter", "Color", levels=-c(1,3,5)), estimate="MPLE")
...
test_that("b2twostar, bipartite, undirected", {
  ...
  e.ab <- ergm(bipnw2~b2twostar(function(x) x %v% "Letter", levels=-c(1,3,5)), estimate="MPLE")
  s.aab <- summary(bipnw2~b2twostar(~Letter, "Color", levels=-(2:4)))
