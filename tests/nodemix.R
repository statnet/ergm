...
stopifnot(all(stats == ergm.godfather(nw ~ nodemix("vattr", form="sum"),response="eattr",changes=changes_godfather)))
...
stopifnot(all(stats[sort(unique(c(m_ind[levs,levs])))] == ergm.godfather(nw ~ nodemix("vattr", levels = levs, form="sum"),response="eattr",changes=changes_godfather)))
...
stats <- rep(0, attr_levels*(attr_levels + 1)/2)
for(i in seq_along(types)) stats[types[i]] <- stats[types[i]] + 1
stopifnot(all(stats == ergm.godfather(nw ~ nodemix("vattr", form="nonzero"),response="eattr",changes=changes_godfather)))
...
stopifnot(all(stats[sort(unique(c(m_ind[levs,levs])))] == ergm.godfather(nw ~ nodemix("vattr", levels = levs, form="nonzero"),response="eattr",changes=changes_godfather)))
...
stopifnot(all(stats == ergm.godfather(nw ~ nodemix("vattr"),changes=changes_godfather)))
stopifnot(all(stats[levs2] == ergm.godfather(nw ~ nodemix("vattr", levels2 = levs2),changes=changes_godfather)))
stopifnot(all(stats[sort(unique(c(m_ind[levs,levs])))] == ergm.godfather(nw ~ nodemix("vattr", levels = levs),changes=changes_godfather)))
...
stopifnot(all(stats == ergm.godfather(nw ~ nodemix("vattr", form="sum"),response="eattr",changes=changes_godfather)))
stopifnot(all(stats[levs2] == ergm.godfather(nw ~ nodemix("vattr", levels2 = levs2, form="sum"),response="eattr",changes=changes_godfather)))
stopifnot(all(stats[sort(unique(c(m_ind[b1levs,b2levs])))] == ergm.godfather(nw ~ nodemix("vattr", b1levels = b1levs, b2levels = b2levs, form="sum"),response="eattr",changes=changes_godfather)))
...
stopifnot(all(stats == ergm.godfather(nw ~ nodemix("vattr", form="nonzero"),response="eattr",changes=changes_godfather)))
stopifnot(all(stats[levs2] == ergm.godfather(nw ~ nodemix("vattr", levels2 = levs2, form="nonzero"),response="eattr",changes=changes_godfather)))
stopifnot(all(stats[sort(unique(c(m_ind[b1levs,b2levs])))] == ergm.godfather(nw ~ nodemix("vattr", b1levels = b1levs, b2levels = b2levs, form="nonzero"),response="eattr",changes=changes_godfather)))
...
stopifnot(all(stats == ergm.godfather(nw ~ nodemix("vattr"),changes=changes_godfather)))
stopifnot(all(stats[levs2] == ergm.godfather(nw ~ nodemix("vattr", levels2 = levs2),changes=changes_godfather)))
stopifnot(all(stats[sort(unique(c(m_ind[b1levs,b2levs])))] == ergm.godfather(nw ~ nodemix("vattr", b1levels = b1levs, b2levels = b2levs),changes=changes_godfather)))
